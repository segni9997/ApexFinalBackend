# Generated by Django 4.2.10 on 2024-03-18 05:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workbooks', to='users.course')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='users.course')),
            ],
        ),
        migrations.CreateModel(
            name='QuizQuestions',
            fields=[
                ...
                ('quiz', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.quiz')),
            ],
        ),
        migrations.CreateModel(
            name='Enrollment',
